...
//bool xmlGetInt(xmlXPathContextPtr ctx, const xmlChar *xpath, int& result, xmlNodePtr curr=0);
...
//Detect the encoding of the html document and re-read.
//htmlDocPtr htmlReadMemory2(const char* buffer, int size, const char* URL, const char * encoding, int options);
