...
[
	...
	AC_ARG_WITH(mysql,
		...
		[MYSQL_lib_check="$withval/lib/mysql $withval/lib"
		MYSQL_inc_check="$withval/include $withval/include/mysql"],
	...
	AC_ARG_WITH(mysql-lib,
		...
		[MYSQL_lib_check="$withval $withval/lib64 $withval/lib $withval/lib64/mysql $withval/lib/mysql"])
	AC_ARG_WITH(mysql-include,
		[  --with-mysql-include=<path> directory path of MySQL header installation],
		[MYSQL_inc_check="$withval $withval/include $withval/include/mysql"])
	...
	AC_TRY_LINK(
        ...
        [ AC_MSG_RESULT([no])	
          ...
          LIBS="$save_LIBS -l$MYSQL_C_LIB -lz"
          AC_TRY_LINK(
              [ #include <mysql.h> ],
              [ mysql_store_result(0); ],
              AC_MSG_RESULT([yes]),
